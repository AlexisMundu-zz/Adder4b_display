...
HD_PWD='C:/Users/alexi/OneDrive - ITESO/Semestre_4/Diseno de Circuitos Digitales/Vivado/Adder4bits_disp/Adder4bits_disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4bits_disp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder4bits_disp.tcl -notrace
