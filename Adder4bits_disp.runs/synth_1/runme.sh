...
HD_PWD='C:/Users/alexi/OneDrive - ITESO/Semestre_4/Diseno de Circuitos Digitales/Vivado/Adder4bits_disp/Adder4bits_disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4bits_disp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder4bits_disp.tcl
